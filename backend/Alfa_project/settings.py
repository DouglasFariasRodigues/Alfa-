...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-3tz@=p$fc=9^@+mi)atwc%+llvkon2(#(&$1frhy)j*+z(aria')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Alfa Project API',
    'DESCRIPTION': 'API para gerenciamento de igreja Alfa',
    'VERSION': '1.0.0',
